...
@section('content')
    <div class="container-fluid mb-4">
        <h1 class="h3 mb-3 text-gray-800">Crear presupuesto</h1>
            ...
            <form action="{{ route('repairs.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row g-3">
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="fullname" id="fullname" class="form-control"
                                placeholder="Ingrese el nombre completo" value="{{ old('fullname') }}">
                        </div>
                        @error('fullname')
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" step="any" name="phone" id="phone" class="form-control"
                                placeholder="Ingrese el teléfono" value="{{ old('phone') }}">
                        </div>
                        @error('phone')
                            <small class="text-danger">{{ '* ' . $message }}</small>
                        @enderror
                    ...
                    <div class="col-md-4 mt-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="vehicle" id="vehicle" class="form-control"
                                placeholder="Ingrese el vehículo" value="{{ old('vehicle') }}">
                        </div>
                        @error('vehicle')
                            <small class="text-danger">{{ '* ' . $message }}</small>
                        @enderror
                    ...
                    <div class="col-md-4 mt-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="type_repair" id="price" class="form-control"
                                placeholder="Ingrese el tipo de reparación" value="{{ old('type_repair') }}">
                        </div>
                        @error('type_repair')
                            <small class="text-danger">{{ '* ' . $message }}</small>
                        @enderror
                    ...
                    <div class="col-md-8 mt-3">
                        ...
                        <textarea name="details" id="details" rows="10" class="form-control">{{ old('details') }}</textarea>
                        @error('details')
                            <small class="text-danger">{{ '* ' . $message }}</small>
                        @enderror
                    </div>
